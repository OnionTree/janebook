	...
	<div class="width-limit">
		<div class="navbar-rightpart" style="float: right;">
			<ul class="nav navbar-nav">
				...
				<li><a href="/janebook/login"><button class="btn btn-custom btn-write"><span class="glyphicon glyphicon-pencil"></span>写文章</button></a></li>
			</ul>
		</div>
			...
			<div class="row">
				<div class="navbar-header">
					<a class="navbar-brand" href="/janebook/index" style="float:left;">
						<img class="logo-top img-rounded" src="/janebook/images/tupian1.jpg" alt=""><span class="logo-text">捡书</span>
					</a>
