...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./emoji/wEmoji.css">
    <script type="text/javascript" src="./js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="./js/bootstrap.min.js"></script>
    <script type="text/javascript" src="./emoji/wEmoji.config.js"></script>
    <script type="text/javascript" src="./emoji/wEmoji.js"></script>
</head>
<css type="text/css">
        ...
        <div class="width-limit">
            <div class="navbar-rightpart" style="float: right;">
                <ul class="nav navbar-nav">
                        ...
                        <div class="modal-popup">
                            <div class="style-mode">
                                <div class="popover-modal">
                                    ...
                                    <div class="switch day-night-group"><a class="switch-btn active">开</a> <a class="switch-btn">关</a></div>
                                    <hr>
                    ...
                    <li>
                        <a href="#">
                            <button class="btn btn-custom btn-write"><span class="glyphicon glyphicon-pencil"></span>我TM写</button>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container main-content">
        <div class="page-container">
            <div class="note">
                <div class="post">
                    <div class="article">
                        <h1 class="title">燃烧你的梦！</h1>
                        <div class="author">
                            <a href="#" class="author-avatar">
									<img src="./images/avatar/quin.jpg" alt="">
								</a>
                            <div class="info">
                                <span class="tag">Gay</span>
                                <span class="name"><a href="#">乌石堰</a></span>
                                <a class="btn btn-success follow">+ 关注</a>
                                <div class="meta">
                                    <!-- 如果文章更新时间大于发布时间，那么使用 tooltip 显示更新时间 -->
                                    <span class="publish-time" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="最后编辑于 2017.09.19 14:07">2017.09.18 16:33*</span>
                                    <span class="wordage">字数 1556</span>
                                    <span class="views-count">阅读 4049</span><span class="comments-count">评论 34</span><span class="likes-count">喜欢 86</span><span class="rewards-count">赞赏 2</span>
                                </div>
                            </div>
                            <!-- 如果是当前作者，加入编辑按钮 -->
                        ...
                        <div class="note-content">
                            <div class="images-package">
                                <img src="./images/note/Gabe.gif" alt="">
                                <div class="image-caption">CMN</div>
                            </div>
                            <div class="note-text">
                    ...
                    <div class="author-detail">
                        <div class="info">
                            <a class="avatar" href="#">
					            	<img src="./images/avatar/quin.jpg" alt="cmn">
								</a>
                            <a class="btn btn-success follow"><span>+ 关注</span></a>
                            <a class="title" href="#">吴氏炎</a>
                            <i class="iconfont icon-man"></i>
                            <p>写了 114514 字，被 233 人关注，获得了 233 个喜欢</p>
                        </div>
                        <div class="signature">情场杀手，原谅达人。</div>
                    </div>
                    ...
                    <div class="comment-list">
                        <div>
                            <form class="new-comment">
                                <a class="avatar"><img src="./images/avatar/ha.jpg"></a>
                            ...
                            <div class="comment" id="">
                                <div>
                                    <div class="author">
                                        <a href="#" target="_blank" class="avatar">
			      								<img src="./images/avatar/ws.gif">
			      							</a>
                                        <div class="info">
                                            <a href="#" target="_blank" class="name">尊敬的王二</a>
                                            <div class="meta">
                                                <span>2楼 · 2017.09.19 22:24</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="comment-wrap">
                                        ...
                                        <div class="tool-group">
                                            <a class=""><i class="iconfont icon-good active"></i> <span>2人赞</span></a>
                                            <a class="reply"><i class="iconfont icon-comments"></i> <span>回复</span></a>
                                ...
                                <div class="sub-comment-list">
                                    <div class="sub-comment">
                                        <p>
                                            <a href="#" target="_blank">手银吴（SY.WU）</a>：
                                            <span><a href="/users/3831847a8bc5" class="maleskine-author" target="_blank">@cmn</a> 去你妈的！写的什么狗屎东西！</span>
                                        </p>
                                        <div class="sub-tool-group">
                                            <span>2017.09.22 11:07</span> <a class="reply"><i class="iconfont icon-comments"></i> <span>回复</span></a>
                                            <a class="report"><span>举报</span></a>
                                            <!---->
                                        </div>
                                    </div>
                                    ...
                                    <div class="sub-comment more-comment">
                                        <a class="add-comment-btn"><i class="iconfont icon-wirte"></i> <span>添加新评论</span></a>
                                        <span class="line-warp">还有N条评论，<a>展开查看</a></span>
                                    </div>
                                    <!---->
                                </div>
                            </div>
                    ...
                    <div class="list">
                        <div class="note have-img">
                            <a class="cover" target="_blank" href="#">
									<img src="./images/note/neko.gif" alt="">
								</a>
                            ...
                            <a target="_blank" href="#" class="author">
                                <div class="avatar" style="">
                                    <img src="./images/avatar/shuangye.png" alt=""><span class="name">孔明君</span>
                                </div>
                            </a>
                        </div>
                        <div class="note have-img">
                            <a class="cover" target="_blank" href="#">
									<img src="./images/note/hu.gif" alt="">
								</a>
                            <a target="_blank" href="#" class="title">你的问题在于你想的太多，又做的太少</a>
                            <p class="description">文|紫苏 离杨绛先生辞世，差不多快满一年，但杨先生的经典语录还在网上流传着。其中一句很受用又一针见血的话：“你的问题主要在于读书不多，而想得太多。”不过我觉得，读书少见识浅，是最容易想太多而做的又少。我说的这种“想”，基本上就等同于白日梦似的坐地空想，虽说是种心理活动，但是少了身体力行就变味了。 01 我有所感，是因为前一阵一个朋友发的消息问我，“你说现在干什么挣钱快”，她觉得现下“以人生钱实在太难，钱生钱就貌似很容易”，总眼红的看别人干什么来钱来得都容易，又常能看到新闻头条里什么“90后网红年入百万”，什么“大学生回乡当农民都能发家致富”…她也坐不住了，想干点什么，但又犹犹豫豫得瞻前顾...</p>
                            <a target="_blank" href="#" class="author">
                        ...
                        <div class="note have-img">
                            <a class="cover" target="_blank" href="#">
									<img src="./images/note/mahuateng.gif" alt="">
								</a>
                            <a target="_blank" href="#" class="title">你的问题在于你想的太多，又做的太少</a>
                            <p class="description">文|紫苏 离杨绛先生辞世，差不多快满一年，但杨先生的经典语录还在网上流传着。其中一句很受用又一针见血的话：“你的问题主要在于读书不多，而想得太多。”不过我觉得，读书少见识浅，是最容易想太多而做的又少。我说的这种“想”，基本上就等同于白日梦似的坐地空想，虽说是种心理活动，但是少了身体力行就变味了。 01 我有所感，是因为前一阵一个朋友发的消息问我，“你说现在干什么挣钱快”，她觉得现下“以人生钱实在太难，钱生钱就貌似很容易”，总眼红的看别人干什么来钱来得都容易，又常能看到新闻头条里什么“90后网红年入百万”，什么“大学生回乡当农民都能发家致富”…她也坐不住了，想干点什么，但又犹犹豫豫得瞻前顾...</p>
                            <a target="_blank" href="#" class="author">
                        ...
                        <div class="note have-img">
                            <a class="cover" target="_blank" href="#">
									<img src="./images/note/xueyou.png" alt="">
								</a>
                            <a target="_blank" href="#" class="title">你的问题在于你想的太多，又做的太少</a>
                            <p class="description">文|紫苏 离杨绛先生辞世，差不多快满一年，但杨先生的经典语录还在网上流传着。其中一句很受用又一针见血的话：“你的问题主要在于读书不多，而想得太多。”不过我觉得，读书少见识浅，是最容易想太多而做的又少。我说的这种“想”，基本上就等同于白日梦似的坐地空想，虽说是种心理活动，但是少了身体力行就变味了。 01 我有所感，是因为前一阵一个朋友发的消息问我，“你说现在干什么挣钱快”，她觉得现下“以人生钱实在太难，钱生钱就貌似很容易”，总眼红的看别人干什么来钱来得都容易，又常能看到新闻头条里什么“90后网红年入百万”，什么“大学生回乡当农民都能发家致富”…她也坐不住了，想干点什么，但又犹犹豫豫得瞻前顾...</p>
                            <a target="_blank" href="#" class="author">
                        ...
                        <div class="note have-img">
                            <a class="cover" target="_blank" href="#">
									<img src="./images/note/ws.gif" alt="">
								</a>
                            <a target="_blank" href="#" class="title">你的问题在于你想的太多，又做的太少</a>
                            <p class="description">文|紫苏 离杨绛先生辞世，差不多快满一年，但杨先生的经典语录还在网上流传着。其中一句很受用又一针见血的话：“你的问题主要在于读书不多，而想得太多。”不过我觉得，读书少见识浅，是最容易想太多而做的又少。我说的这种“想”，基本上就等同于白日梦似的坐地空想，虽说是种心理活动，但是少了身体力行就变味了。 01 我有所感，是因为前一阵一个朋友发的消息问我，“你说现在干什么挣钱快”，她觉得现下“以人生钱实在太难，钱生钱就貌似很容易”，总眼红的看别人干什么来钱来得都容易，又常能看到新闻头条里什么“90后网红年入百万”，什么“大学生回乡当农民都能发家致富”…她也坐不住了，想干点什么，但又犹犹豫豫得瞻前顾...</p>
                            <a target="_blank" href="#" class="author">
...
$(function(commom) {
    ...
    $(document).click(function(e) {
        ...
        if (!flag && emojibox.children().index(_this) == -1) {
            $(".note .post .comment-list .new-comment .emoji-con").hide();
...
emoji({textbox:'#subText', emojibox:'.wrapper'});
function emoji(parm) {
...
function publish_comment2(event) {
    ...
    if (val.length >= 5 && val.trim().length != 0) {
        ...
        var new_comment = '<div class="sub-comment">' +
                                        '<p>' +
                                            '<a href="#" target="_blank">${tuser.nickname}</a>：' +
                                            '<span><a href="/users/3831847a8bc5" class="maleskine-author" target="_blank">@cmn</a></span>' +
                                        '</p>' +
                                        '<div class="sub-tool-group">' +
                                            '<span>2017.09.22 11:07</span> <a class="reply"><i class="iconfont icon-comments"></i> <span>回复</span></a>' +
                                            '<a class="report"><span>举报</span></a>' +
