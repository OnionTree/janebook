    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side layui-bg-black">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    ...
                    <li class="layui-nav-item layui-this"><a href="admin-user">用户管理</a></li>
        ...
        <div class="layui-body">
            ...
            <div class="layui-footer">
                <blockquote class="layui-elem-quote">管理用户。</blockquote>
            </div>
        </div>
        <div id="pop-cont" style="position: absolute; z-index: 99999; width:100%; height: 100%; background: #eee; display: none;  ">
            <div id="add-classify-box">
                <div class="layui-upload" style="height: 100px; width: 91px; margin: 25px auto;">
                    <img id="user-img" class="layui-upload-img" id="classify-img" style="height: 91px; width: 91px; border: 2px solid #eee; border-radius: 50%" src="./pic/timg.jpg" />
                </div>
                <form class="layui-form" action="" style="margin-top: 10px; margin-left:100px;">
                    <div class="layui-form-item">
                        <label class="layui-form-label">用户名&nbsp; :</label>
                        <label class="layui-form-label" id="username">wahahah</label>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">昵称&nbsp; :</label>
                        <label class="layui-form-label" id="nickname">wahahah</label>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">性别&nbsp; :</label>
                        <label class="layui-form-label" id="sex">wahahah</label>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">Phone&nbsp; :</label>
                        <label class="layui-form-label" id="phone">wahahah</label>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">个人简介&nbsp; :</label>
                        <label class="layui-form-label" id="info">wahahah</label>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">推荐该作者</label>
                        <div class="layui-input-block">
                            <input id="user-rec" type="checkbox" name="open" lay-skin="switch" lay-filter="switchTest" lay-text="是|否">
                        </div>
                    </div>
                </form>
            </div>
