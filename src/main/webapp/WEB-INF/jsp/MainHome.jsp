...
<html lang="zh-CN">
	...
	<style type="text/css" role="no-log-in-nav">
			...
			<div class="width-limit">
				<div class="navbar-rightpart" style="float: right;">
						<ul class="nav navbar-nav">
							...
							<li><a href="/janebook/login.html">登陆</a></li>
							<li><a href="/janebook/register.html"><button class="btn btn-custom btn-sign-up" type="button">注册</button></a></li>
